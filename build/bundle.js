...
var app = (function () {
    ...
    ***************************************************************************** */function y(e,n){var t={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&n.indexOf(o)<0&&(t[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var r=0;for(o=Object.getOwnPropertySymbols(e);r<o.length;r++)n.indexOf(o[r])<0&&Object.prototype.propertyIsEnumerable.call(e,o[r])&&(t[o[r]]=e[o[r]]);}return t}const v={fallbackLocale:null,initialLocale:null,loadingDelay:200,formats:{number:{scientific:{notation:"scientific"},engineering:{notation:"engineering"},compactLong:{notation:"compact",compactDisplay:"long"},compactShort:{notation:"compact",compactDisplay:"short"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},warnOnMissingMessages:!0};function O(){return v}function j(e){const{formats:n}=e,t=y(e,["formats"]),o=e.initialLocale||e.fallbackLocale;return Object.assign(v,t,{initialLocale:o}),n&&("number"in n&&Object.assign(v.formats.number,n.number),"date"in n&&Object.assign(v.formats.date,n.date),"time"in n&&Object.assign(v.formats.time,n.time)),x.set(o)}const L=writable(!1);let k;const x=writable(null);function E(e,n){return 0===n.indexOf(e)&&e!==n}function D(e,n){return e===n||E(e,n)||E(n,e)}function I(e){const n=e.lastIndexOf("-");if(n>0)return e.slice(0,n);const{fallbackLocale:t}=O();return t&&!D(e,t)?t:null}function N(e){const n=e.split("-").map(((e,n,t)=>t.slice(0,n+1).join("-"))),{fallbackLocale:t}=O();return t&&!D(e,t)?n.concat(N(t)):n}function P(){return k}x.subscribe((e=>{k=e,"undefined"!=typeof window&&document.documentElement.setAttribute("lang",e);}));const S=x.set;x.set=e=>{if(s(e)&&w(e)){const{loadingDelay:n}=O();let t;return "undefined"!=typeof window&&null!=P()&&n?t=window.setTimeout((()=>L.set(!0)),n):L.set(!0),h(e).then((()=>{S(e);})).finally((()=>{clearTimeout(t),L.set(!1);}))}return S(e)},x.update=e=>S(e(k));const F=()=>"undefined"==typeof window?null:window.navigator.language||window.navigator.languages[0],C={},J=(e,n)=>{if(null==n)return null;const t=u(n,e);return t||J(e,I(n))},U=(e,n)=>{if(n in C&&e in C[n])return C[n][e];const t=J(e,n);return t?((e,n,t)=>t?(n in C||(C[n]={}),e in C[n]||(C[n][e]=t),t):t)(e,n,t):null},_=e=>{const n=Object.create(null);return t=>{const o=JSON.stringify(t);return o in n?n[o]:n[o]=e(t)}},q=(e,n)=>{const{formats:t}=O();if(e in t&&n in t[e])return t[e][n];throw new Error(`[svelte-i18n] Unknown "${n}" ${e} format.`)},B=_((e=>{var{locale:n,format:t}=e,o=y(e,["locale","format"]);if(null==n)throw new Error('[svelte-i18n] A "locale" must be set to format numbers');return t&&(o=q("number",t)),new Intl.NumberFormat(n,o)})),G=_((e=>{var{locale:n,format:t}=e,o=y(e,["locale","format"]);if(null==n)throw new Error('[svelte-i18n] A "locale" must be set to format dates');return t?o=q("date",t):0===Object.keys(o).length&&(o=q("date","short")),new Intl.DateTimeFormat(n,o)})),H=_((e=>{var{locale:n,format:t}=e,o=y(e,["locale","format"]);if(null==n)throw new Error('[svelte-i18n] A "locale" must be set to format time values');return t?o=q("time",t):0===Object.keys(o).length&&(o=q("time","short")),new Intl.DateTimeFormat(n,o)})),K=(e={})=>{var{locale:n=P()}=e,t=y(e,["locale"]);return B(Object.assign({locale:n},t))},Q=(e={})=>{var{locale:n=P()}=e,t=y(e,["locale"]);return G(Object.assign({locale:n},t))},R=(e={})=>{var{locale:n=P()}=e,t=y(e,["locale"]);return H(Object.assign({locale:n},t))},V=_(((e,n=P())=>new IntlMessageFormat(e,n,O().formats))),W=(e,n={})=>{"object"==typeof e&&(e=(n=e).id);const{values:t,locale:o=P(),default:r}=n;if(null==o)throw new Error("[svelte-i18n] Cannot format a message without first setting the initial locale.");let i=U(e,o);return i||(O().warnOnMissingMessages&&console.warn(`[svelte-i18n] The message "${e}" was not found in "${N(o).join('", "')}".${w(P())?"\n\nNote: there are at least one loader still registered to this locale that wasn't executed.":""}`),i=r||e),t?V(i,o).format(t):i},X=(e,n)=>R(n).format(e),Y=(e,n)=>Q(n).format(e),ee=(e,n)=>K(n).format(e),ne=derived([x,a],(()=>W)),te=derived([x],(()=>X)),oe=derived([x],(()=>Y)),re=derived([x],(()=>ee));
    ...
    /* src/components/Invoice/Company.svelte generated by Svelte v3.29.7 */
    const file$6 = "src/components/Invoice/Company.svelte";

    // (11:12) <Label>
    function create_default_slot_3(ctx) {
    	let t0_value = /*$_*/ ctx[1]("company.name") + "";
    	let t0;
    	let t1;
    	let input;
    	let updating_value;
    	...
    	if (/*company*/ ctx[0].name !== void 0) {
    		input_props.value = /*company*/ ctx[0].name;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*$_*/ 2) && t0_value !== (t0_value = /*$_*/ ctx[1]("company.name") + "")) set_data_dev(t0, t0_value);
    			const input_changes = {};

    			if (!updating_value && dirty & /*company*/ 1) {
    				updating_value = true;
    				input_changes.value = /*company*/ ctx[0].name;
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 7, 0, 186);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	return [company, $_, input_value_binding];
    }

    class Company_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { company: 0 });
    ...
    /* src/components/Invoice/Invoice.svelte generated by Svelte v3.29.7 */
    const file$7 = "src/components/Invoice/Invoice.svelte";

    // (11:12) <Label>
    function create_default_slot_6(ctx) {
    	let t0_value = /*$_*/ ctx[1]("invoice.title") + "";
    	let t0;
    	let t1;
    	let input;
    	let updating_value;
    	...
    	if (/*invoice*/ ctx[0].title !== void 0) {
    		input_props.value = /*invoice*/ ctx[0].title;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*$_*/ 2) && t0_value !== (t0_value = /*$_*/ ctx[1]("invoice.title") + "")) set_data_dev(t0, t0_value);
    			const input_changes = {};

    			if (!updating_value && dirty & /*invoice*/ 1) {
    				updating_value = true;
    				input_changes.value = /*invoice*/ ctx[0].title;
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	function company_company_binding(value) {
    		/*company_company_binding*/ ctx[3].call(null, value);
    	}
    	...
    	company = new Company_1({ props: company_props, $$inline: true });
    ...
    function create_default_slot_1(ctx) {
    	...
    	function company_company_binding_1(value) {
    		/*company_company_binding_1*/ ctx[4].call(null, value);
    	}
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "invoice");
    			add_location(div, file$7, 7, 0, 177);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Invoice> was created with unknown prop '${key}'`);
    	});
    ...
    class Invoice extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { invoice: 0 });
    		...
    		if (/*invoice*/ ctx[0] === undefined && !("invoice" in props)) {
    			console.warn("<Invoice> was created without expected prop 'invoice'");
    		}
    	}
    ...
    /* src/components/Wrapper/Wrapper.svelte generated by Svelte v3.29.7 */

    const file$8 = "src/components/Wrapper/Wrapper.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			attr_dev(div, "class", "wrapper svelte-94h97e");
    			add_location(div, file$8, 3, 0, 3);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/Document/Document.svelte generated by Svelte v3.29.7 */

    const file$9 = "src/components/Document/Document.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			attr_dev(div, "class", "document page svelte-14osdck");
    			add_location(div, file$9, 2, 0, 2);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class DataFactory {
        constructor(locale, dateFormat, country, currency) {
            this.invoice = () => new Invoice$1(this.country, this.currency, this.locale, this.dateFormat);
        ...
        static default() {
            ...
            const dateFormat = formats[locale] || formats[DEFAULT_LOCALE];
    ...
    // (17:12) <Button on:click={downloadPDF} title={$_('buttons.download_pdf')} >
    function create_default_slot_2$2(ctx) {
    	let t_value = /*$_*/ ctx[2]("buttons.download_pdf") + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$_*/ 4 && t_value !== (t_value = /*$_*/ ctx[2]("buttons.download_pdf") + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(17:12) <Button on:click={downloadPDF} title={$_('buttons.download_pdf')} >",
    		ctx
    	});
    ...
    // (28:8) <Document bind:this={document}>
    function create_default_slot_1$1(ctx) {
    	let invoice_1;
    	let updating_invoice;
    	let current;

    	function invoice_1_invoice_binding(value) {
    		/*invoice_1_invoice_binding*/ ctx[4].call(null, value);
    	}

    	let invoice_1_props = {};

    	if (/*invoice*/ ctx[0] !== void 0) {
    		invoice_1_props.invoice = /*invoice*/ ctx[0];
    	}

    	invoice_1 = new Invoice({ props: invoice_1_props, $$inline: true });
    	binding_callbacks.push(() => bind(invoice_1, "invoice", invoice_1_invoice_binding));
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:8) <Document bind:this={document}>",
    		ctx
    	});
    ...
    function create_default_slot$2(ctx) {
    	let h1;
    	let t0_value = /*$_*/ ctx[2]("page.home.title") + "";
    	let t0;
    	let t1;
    	let code;
    	let t2_value = /*invoice*/ ctx[0].title + "";
    	let t2;
    	let t3;
    	let t4_value = /*invoice*/ ctx[0].client.name + "";
    	let t4;
    	let t5;
    	let document_1;
    	let current;

    	let document_1_props = {
    		$$slots: { default: [create_default_slot_1$1] },
    		$$scope: { ctx }
    	};

    	document_1 = new Document({ props: document_1_props, $$inline: true });
    	/*document_1_binding*/ ctx[5](document_1);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "text-primary text-center");
    			add_location(h1, file$a, 22, 8, 659);
    			attr_dev(code, "class", "text-white");
    			attr_dev(code, "type", "json");
    			add_location(code, file$a, 23, 8, 733);
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(document_1, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*$_*/ 4) && t0_value !== (t0_value = /*$_*/ ctx[2]("page.home.title") + "")) set_data_dev(t0, t0_value);
    			if ((!current || dirty & /*invoice*/ 1) && t2_value !== (t2_value = /*invoice*/ ctx[0].title + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*invoice*/ 1) && t4_value !== (t4_value = /*invoice*/ ctx[0].client.name + "")) set_data_dev(t4, t4_value);
    			const document_1_changes = {};

    			if (dirty & /*$$scope, invoice*/ 65) {
    				document_1_changes.$$scope = { dirty, ctx };
    			}

    			document_1.$set(document_1_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    		...
    		d: function destroy(detaching) {
    			...
    			/*document_1_binding*/ ctx[5](null);
    			destroy_component(document_1, detaching);
    		}
    	};
    ...
    function create_fragment$c(ctx) {
    	...
    	button = new Button({
    			props: {
    				title: /*$_*/ ctx[2]("buttons.download_pdf"),
    	...
    	button.$on("click", /*downloadPDF*/ ctx[3]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$a, 15, 8, 456);
    			attr_dev(aside, "class", "svelte-1rmzlrf");
    			add_location(aside, file$a, 14, 4, 440);
    			attr_dev(div, "class", "content svelte-1rmzlrf");
    			add_location(div, file$a, 13, 0, 414);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$_*/ 4) button_changes.title = /*$_*/ ctx[2]("buttons.download_pdf");
    			...
    			if (dirty & /*$$scope, document, invoice, $_*/ 71) {
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	function document_1_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			document = $$value;
    			$$invalidate(1, document);
    		});
    	}
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$c, 13, 8, 356);
    			add_location(div, file$c, 18, 8, 503);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$c, 11, 0, 316);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$e, create_fragment$e, safe_not_equal, { url: 0, pages: 1 });
