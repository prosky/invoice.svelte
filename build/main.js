...
/* src/pages/Settings.svelte generated by Svelte v3.29.7 */
...
function create_default_slot_1(ctx) {
	let t_value = /*$_*/ ctx[2](`page.${/*key*/ ctx[4]}.title`) + "";
	let t;
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*$_*/ 4 && t_value !== (t_value = /*$_*/ ctx[2](`page.${/*key*/ ctx[4]}.title`) + "")) set_data_dev(t, t_value);
		},
		d: function destroy(detaching) {
...
function create_each_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(15:12) {#each pages as [to,key]}",
		ctx
	});
...
// (20:12) {#each pages as [path,key,component]}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(20:12) {#each pages as [path,key,component]}",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(nav, file$3, 13, 8, 356);
			add_location(div, file$3, 18, 8, 503);
		},
		m: function mount(target, anchor) {
...
function create_fragment$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			h1 = element("h1");
			h1.textContent = "Neco";
			add_location(h1, file$3, 24, 4, 657);
			attr_dev(main, "class", "svelte-g8du44");
			add_location(main, file$3, 11, 0, 316);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$5($$self, $$props, $$invalidate) {
	...
	let { url = "" } = $$props;
	const pages = [["/", "home", Home], ["settings", "settings", Settings]];
...
class App extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$5, create_fragment$5, safe_not_equal, { url: 0, pages: 1 });
...
b('en', () => import('./en-3703f142.js'));
b('cs', () => import('./cs-cc351965.js'));
const app = new App({
