...
<div class="company">
    <TextField autocomplete="organization" bind:value={company.name}>{$_(`company.name`)}</TextField>
    <TextField autocomplete="address-line1" bind:value={company.address}>{$_(`company.address`)}</TextField>
